  ...
  getDashboardStats(): Observable<StatCard[]> {
    return forkJoin({
      ...
      map(({ transferts, declarations, regles, utilisateurs, agences }) => {
        ...
        return [
          {
            label: 'manager.dashboard.stats.revenue',
          ...
          {
            label: 'manager.dashboard.stats.commissions',
          ...
          {
            label: 'manager.dashboard.stats.pending',
          ...
          {
            label: 'manager.dashboard.stats.amlAlerts',
          ...
          {
            label: 'manager.dashboard.stats.amlRules',
            value: `${reglesActives}`,
          ...
          {
            label: 'manager.dashboard.stats.agentsAgences',
